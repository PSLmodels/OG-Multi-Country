...
\section{Add Children}
	...
	\begin{align}
		 ...
		 \left[ \frac{1}{\bar \ell} \left( 1-\left(\frac{{c_{i,s+j,t+j}}^{-\sigma} w_{i,t+j} e_{s+j,t+j}}{\chi_\ell} \right)^{\frac{\mu}{1-\mu}} \right) \right]^{-\frac{1}{\mu}}  & = \bar \ell-\ell_{i,s+j,t+j} \nonumber \\
		 \ell_{i,s+j,t+j} & = \bar \ell -  \left[\frac{1}{\bar \ell} \left( 1-\left(\frac{{c_{i,s+j,t+j}}^{-\sigma} w_{i,t+j} e_{s+j,t+j}}{\chi_\ell} \right)^{\frac{\mu}{1-\mu}} \right) \right]^{-\frac{1}{\mu}} \label{eq_4elldefnon}
	\end{align}
	...
	\begin{align}
		...
		\hat \ell_{ist} & = \bar \ell - \left[\frac{1}{\bar \ell} \left( 1-\left(\frac{{c_{ist}}^{-\sigma} w_{it} e_{st}}{\chi_\ell} \right)^{\frac{\mu}{1-\mu}} \right) \right]^{-\frac{1}{\mu}}; \forall i,s \label{eq_4elldef} \\
