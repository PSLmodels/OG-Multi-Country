...
\section{Add Children}
	...
	\begin{align}
		 ...
		 \ell_{i,s+j,t+j} & = \bar \ell - \frac{1}{\bar \ell} \left[ 1-\left(\frac{{c_{i,s+j,t+j}}^{-\sigma} w_{i,t+j} e_{s+j,t+j}}{\chi_\ell} \right)^{\frac{\mu}{1-\mu}} \right]^{-\frac{1}{\mu}} \label{eq_4elldefnon}
	\end{align}
	...
	\begin{align}
		...
		\hat \ell_{ist} & = \bar \ell - \frac{1}{\bar \ell} \left[ 1-\left(\frac{{c_{ist}}^{-\sigma} w_{it} e_{st}}{\chi_\ell} \right)^{\frac{\mu}{1-\mu}} \right]^{-\frac{1}{\mu}}; \forall i,s \label{eq_4elldef} \\
...
\section{Adding Different Types of Labor}
	...
	\begin{align}
    	...
    	\hat \ell_{ijst} & = \bar \ell - \frac{1}{\bar \ell} \left[ 1-\left(\frac{{c_{ijst}}^{-\sigma} w_{ijt} e_{sjt}}{\chi_\ell} \right)^{\frac{\mu}{1-\mu}} \right]^{-\frac{1}{\mu}}; \forall i,j,s \label{eq_5elldef} \\
...
\section{Adding Corporate Taxes}
	...
	\begin{align}
    	...
    	\hat \ell_{ijst} & = \bar \ell - \frac{1}{\bar \ell} \left[ 1-\left(\frac{{c_{ijst}}^{-\sigma} w_{ijt} e_{sjt}}{\chi_\ell} \right)^{\frac{\mu}{1-\mu}} \right]^{-\frac{1}{\mu}}; \forall i,j,s \label{eq_6elldef} \\
