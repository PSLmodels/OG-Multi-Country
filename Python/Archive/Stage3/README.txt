With the demographics completed, Stage 3 adds endogenous labor.
This stage also added vectorizing code in order to make it faster.
This readme gives a big picture description
...
pure_cython.iso-- The object that is callable from python.
...
UsingCython.txt- Gives brief instruction on using Cython for the model. 
