...
lived agents overlapping generations model (OLG). There are no complicated 
demographics. Each country produces the same single good which is moble 
across country borders. In each country there is a representative firm.
Examine the step by step document in the notes section for more details.
