...
assets_ss, kf_ss, k_ss, n_ss, y_ss, r_ss, w_ss, c_vec_ss = Stepfuncs.getSteadyState(params_ss, assets_guess, kf_guess)
...
if CalcTPI==True: #Time Path Iteration, activated by line 24
	...
	assets_init, kf_init, w_initguess, r_initguess, k_init, n_init, y_init, c_init = \
	...
	wpath, rpath, cpath, kpath, ypath = Stepfuncs.get_Timepath(tp_params, w_initguess, r_initguess, assets_init, k_ss, kf_ss, w_ss, r_ss)
